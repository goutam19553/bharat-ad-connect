        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://www.linkedin.com/company/the-adz-project/" className="text-gray-300 hover:text-bharat-saffron">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center">
                ...
                <a href="mailto:Theadproject01@gmail.com" className="text-gray-300 hover:text-bharat-saffron">

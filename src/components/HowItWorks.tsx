  ...
  return (
    <section className="relative py-20 px-4 md:px-16 bg-gray-800 text-white overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto z-10 how-it-works-container">
        <div className="absolute top-0 left-1/2 transform -translate-x-1/2 h-full w-1 bg-gradient-to-b from-blue-500 via-purple-500 to-blue-500 z-0" />
            ...
            <div key={index} className="relative">
              <motion.div
                ...
                className={cn(
                  ...
                  index % 2 === 0
                    ? 'md:flex-row-reverse text-right step-right'
                    : 'md:flex-row text-left step-left'
                )}
              >
                {/* Connector Line */}

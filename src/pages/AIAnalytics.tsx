      ...
      <div className="container mx-auto px-4">
        ...
        >
          <ToggleGroup type="single" value={activeAnalysis} onValueChange={(value) => value && setActiveAnalysis(value as AnalysisType)}>
            <ToggleGroupItem value="demographics" className={`${isDarkMode ? 'text-white data-[state=on]:bg-gray-700' : ''} flex items-center gap-1.5`}>
              <ChartPie className="w-4 h-4" />
              <span>Demographics</span>
            </ToggleGroupItem>
            <ToggleGroupItem value="insights" className={`${isDarkMode ? 'text-white data-[state=on]:bg-gray-700' : ''} flex items-center gap-1.5`}>
              <LightbulbIcon className="w-4 h-4" />
              <span>AI Insights</span>
            </ToggleGroupItem>
            <ToggleGroupItem value="prediction" className={`${isDarkMode ? 'text-white data-[state=on]:bg-gray-700' : ''} flex items-center gap-1.5`}>
        ...
        <motion.div 
          className={`rounded-xl shadow-xl overflow-hidden ${isDarkMode 
            ? 'bg-gray-800/80 border border-gray-700 backdrop-blur-sm' 
            : 'bg-white border border-gray-200'} 
            transition-colors duration-300 hover:shadow-2xl hover:shadow-ad-purple/5`}
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true }}
          variants={fadeInVariants}
            ...
            <div className="p-6 lg:p-8">
              <div className="flex flex-col md:flex-row gap-8">
                <div className="md:w-2/3">
                  <div className="mb-4 flex justify-between items-center">
                    ...
                    <Badge variant="outline" className={`${isDarkMode 
                      ? 'border-ad-purple text-ad-purple' 
                      : 'border-ad-blue text-ad-blue'}`}>
                      Real-time Data
                    </Badge>
                  </div>
                  
                  <div className={`h-96 rounded-xl p-4 ${isDarkMode 
                    ? 'bg-gradient-to-br from-transparent via-gray-800/80 to-ad-purple/10' 
                    : 'bg-gradient-to-br from-transparent via-transparent to-ad-purple/5'}`}>
                ...
                <div className="md:w-1/3">
                  <Card className={`h-full ${isDarkMode 
                    ? 'bg-gray-900 border-gray-700 shadow-inner shadow-ad-purple/10' 
                    : 'bg-gray-50 shadow-md'}`}>
                    <CardHeader>
                      <CardTitle className={`text-lg ${isDarkMode ? 'text-white' : 'text-ad-blue'}`}>
                    ...
                    <CardContent className="space-y-6">
                      ...
                      <div>
                        ...
                        <div className={`flex items-center p-3 rounded-lg ${isDarkMode 
                      ...
                      <div>
                        ...
                        <p className={`${isDarkMode ? 'text-gray-400' : 'text-gray-600'} leading-relaxed`}>
                          Focus creative efforts on the 25-34 demographic with gender-inclusive 
                          messaging to maximize engagement across all segments.
                        </p>
                      </div>
                    </CardContent>
                  </Card>
              ...
              <div className={`mt-6 p-4 rounded-lg ${isDarkMode 
                ...
                <p className={`${isDarkMode ? 'text-gray-300' : 'text-gray-600'} leading-relaxed`}>
                  Our AI has detected strong engagement patterns in the 25-34 age group across all genders. 
                  Female viewers show slightly higher engagement across all demographics. The system recommends 
                  adjusting your creative strategy to better appeal to the 45+ segments where engagement 
                ...
                <div className="lg:w-2/3">
                  <div className="mb-4 flex flex-wrap justify-between items-center gap-2">
                    ...
                    <Badge className="bg-ad-purple hover:bg-ad-purple/90 text-white">
                      <BrainCircuit className="w-3 h-3 mr-1" /> Neural Networks
                    </Badge>
                  </div>
                  
                  <Card className={`overflow-hidden ${isDarkMode 
                    ? 'bg-gray-900 border-gray-700 shadow-ad-purple/10 shadow-inner' 
                    ...
                    <div className="max-h-[500px] overflow-auto scrollbar-thin">
                      <Table>
                        <TableHeader className="sticky top-0">
                          <TableRow className={isDarkMode 
                            ? 'border-gray-700 bg-gray-900' 
                            : 'bg-white'}>
                            <TableHead className="w-[80px]">#</TableHead>
                            <TableHead className="min-w-[180px]">Key Insight</TableHead>
                        ...
                        <TableBody>
                          {aiInsights.map((insight) => (
                            <TableRow key={insight.id} className={`${isDarkMode 
                              ...
                              <TableCell className="text-right max-w-[300px]">
                                <p className="truncate">{insight.action}</p>
                              </TableCell>
                            </TableRow>
                          ))}
                        </TableBody>
                  ...
                  <Card className={`h-full ${isDarkMode 
                    ...
                    <CardContent className="space-y-4">
                      ...
                      <div className="text-center pt-4">
                        <motion.div 
                          className={`inline-block px-3 py-1 rounded-full ${isDarkMode 
                            ? 'bg-ad-purple/20 text-ad-purple' 
                            : 'bg-ad-blue/10 text-ad-blue'} text-xs font-medium`}
          ...
          {activeAnalysis === 'prediction' && (
            <div className="p-6 lg:p-8">
              <div className="mb-6">
                ...
                <div className={`rounded-xl p-4 mb-6 ${isDarkMode 
                  ? 'bg-gradient-to-br from-transparent via-gray-800/50 to-ad-purple/10 border border-gray-700' 
                  : 'bg-gradient-to-br from-transparent via-transparent to-ad-purple/5'}`}>
                  <div className="h-72">
                    <ChartContainer config={chartConfig}>
                      <ResponsiveContainer width="100%" height="100%">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                <motion.div whileHover={{ y: -5, transition: { duration: 0.2 } }}>
                  <Card className={`${isDarkMode 
                    ? 'bg-gray-900 border-gray-700 shadow-inner shadow-green-500/5' 
                    : 'bg-white border border-gray-200 shadow'} overflow-hidden`}>
                ...
                <motion.div whileHover={{ y: -5, transition: { duration: 0.2 } }}>
                  <Card className={`${isDarkMode 
                    ? 'bg-gray-900 border-gray-700 shadow-inner shadow-purple-500/5' 
                    : 'bg-white border border-gray-200 shadow'} overflow-hidden`}>
                ...
                <motion.div whileHover={{ y: -5, transition: { duration: 0.2 } }}>
                  <Card className={`${isDarkMode 
                    ? 'bg-gray-900 border-gray-700 shadow-inner shadow-orange-500/5' 
                    : 'bg-white border border-gray-200 shadow'} overflow-hidden`}>
              ...
              <Card className={`${isDarkMode 
                ? 'bg-gray-800/80 border-gray-700 shadow-lg shadow-ad-purple/5' 
                : 'bg-gray-50 border-gray-200 shadow-md'}`}>
                <CardHeader className="pb-2">

  ...
  return (
    <div className="bg-gray-900 text-white dark:bg-white dark:text-black">
      ...
      <section className="section bg-gray-800 dark:bg-gray-100">
        <div className="container-custom">
          <div className="text-center">
            <h2 className="text-2xl font-semibold mb-6 text-white dark:text-black">AR Advertising Examples</h2>
      ...
      <section className="bg-gray-800 dark:bg-gray-100 py-16">
        <div className="container-custom">
          <h2 className="text-2xl font-semibold text-center mb-8 text-white dark:text-black">Our AR Services</h2>
      ...
      <section className="bg-gray-800 dark:bg-gray-100 py-16">
        <div className="container-custom">
          <h2 className="text-2xl font-semibold text-center mb-8 text-white dark:text-black">How It Works</h2>

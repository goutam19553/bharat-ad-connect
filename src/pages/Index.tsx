      ...
      <div className="relative">
        ...
        <div className="relative z-10">
          ...
          <section className="section bg-gray-50 dark:bg-gray-800">
            <div className="container-custom">
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                  We help streamline OOH Ad-campaign planning with advanced tools
                  and proprietary data insights for precise media placement.
                </p>
              </div>
          ...
          <section className="my-16 text-center">
            <Link
              to="/political-campaign-support"
              className="inline-block rounded-lg border-2 border-bharat-saffron bg-gradient-to-r from-bharat-saffron to-bharat-navy py-4 px-8 text-xl font-bold text-white shadow-lg transition duration-300 hover:scale-105 hover:shadow-xl"
              aria-label="Support Political Campaigns"
            >
          ...
          <section className="section bg-white dark:bg-gray-800">
            <div className="container-custom">
              <div className="text-center mb-12">
                <h2 className="text-3xl md:text-4xl font-bold mb-4">
                  AI & AR Ad-Preview Demos
                </h2>
                <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                  Experience our AI-driven tools and immersive AR previews for ad
                  campaigns.
                </p>
              </div>
